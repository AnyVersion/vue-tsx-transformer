...
function createSelectVModel(expression) {
    ...
    return [
        ...
        typescript_1.factory.createJsxAttribute(typescript_1.factory.createIdentifier('onChange'), typescript_1.factory.createJsxExpression(undefined, typescript_1.factory.createArrowFunction(undefined, undefined, [(0, util_1.createParameterDeclaration)("$$event")], undefined, typescript_1.factory.createToken(typescript_1.default.SyntaxKind.EqualsGreaterThanToken), typescript_1.factory.createBlock([
            typescript_1.factory.createVariableStatement(undefined, typescript_1.factory.createVariableDeclarationList([typescript_1.factory.createVariableDeclaration(typescript_1.factory.createIdentifier("$$selectedVal"), undefined, undefined, typescript_1.factory.createCallExpression(typescript_1.factory.createPropertyAccessExpression(typescript_1.factory.createCallExpression(typescript_1.factory.createPropertyAccessExpression(typescript_1.factory.createPropertyAccessExpression(typescript_1.factory.createPropertyAccessExpression(typescript_1.factory.createIdentifier("Array"), typescript_1.factory.createIdentifier("prototype")), typescript_1.factory.createIdentifier("filter")), typescript_1.factory.createIdentifier("call")), undefined, [
                    typescript_1.factory.createPropertyAccessExpression(typescript_1.factory.createPropertyAccessExpression(typescript_1.factory.createIdentifier("$$event"), typescript_1.factory.createIdentifier("target")), typescript_1.factory.createIdentifier("options")),
                    typescript_1.factory.createArrowFunction(undefined, undefined, [(0, util_1.createParameterDeclaration)("o")], undefined, typescript_1.factory.createToken(typescript_1.default.SyntaxKind.EqualsGreaterThanToken), typescript_1.factory.createPropertyAccessExpression(typescript_1.factory.createIdentifier("o"), typescript_1.factory.createIdentifier("selected")))
                ]), typescript_1.factory.createIdentifier("map")), undefined, [typescript_1.factory.createArrowFunction(undefined, undefined, [(0, util_1.createParameterDeclaration)("o")], undefined, typescript_1.factory.createToken(typescript_1.default.SyntaxKind.EqualsGreaterThanToken), typescript_1.factory.createConditionalExpression(typescript_1.factory.createBinaryExpression(typescript_1.factory.createStringLiteral("_value"), typescript_1.factory.createToken(typescript_1.default.SyntaxKind.InKeyword), typescript_1.factory.createIdentifier("o")), typescript_1.factory.createToken(typescript_1.default.SyntaxKind.QuestionToken), typescript_1.factory.createPropertyAccessExpression(typescript_1.factory.createIdentifier("o"), typescript_1.factory.createIdentifier("_value")), typescript_1.factory.createToken(typescript_1.default.SyntaxKind.ColonToken), typescript_1.factory.createPropertyAccessExpression(typescript_1.factory.createIdentifier("o"), typescript_1.factory.createIdentifier("value"))))]))], typescript_1.default.NodeFlags.Const)),
